...
const Sidebar = ({ lists, count, onAddList, INBOX_LIST_ID, selectedList, onDeleteList, onChangeListName }) => {
	return (
		<aside className='sidebar'>
			<div className='sidebar-list-container'>
				<h1 className='todoapp-header'>ToDoApp</h1>
				<div className='sidebar-list'>
					<div className={`sidebar-list-element ${selectedList === INBOX_LIST_ID && 'sidebar-list-element-active'}`} id={INBOX_LIST_ID}>
